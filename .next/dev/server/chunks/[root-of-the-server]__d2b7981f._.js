...
async function GET() {
    try {
        ...
        const analysisLeaders = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].analysis.groupBy({
            by: [
                'guestId'
            ],
            _count: {
        ...
        const pathwayLeaders = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].pathway.groupBy({
            by: [
                'guestId'
            ],
            _count: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d2b7981f._.js.map