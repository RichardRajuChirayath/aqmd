...
function HomePage() {
    ...
    const handleAnalyze = async ()=>{
        ...
        setIsLoading(true);
        try {
            const response = await fetch((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$url$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiUrl"])("/api/analyze-intent"), {
                method: "POST",
                headers: {
...
_s(HomePage, "xKciDnXP11+X0yDlPswg8GDjOvk=", false, function() {
    return [
...
_s1(LinkButton, "fN7XvhJ+p5oE6+Xlo0NJmXpxjC8=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
...
//# sourceMappingURL=_24be54cd._.js.map